...
<html lang="en">
<head>
    <title>Sports Club Altenstadt - Login - Failure</title>
    <meta charset="utf-8">
...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div class="p-4 p-md-5 pt-5" id="content">
        ...
        <div class="card text-white bg-danger">
            ...
            <div class="card-body">
                <h5 class="card-title">Wrong User ID or Password</h5>
                <p class="card-text">
                    The user ID and/or password you entered is incorrect.<br>
                    Please try again.
                </p>
            </div>
            <div class="card-footer bg-transparent border-danger">
                <a href="index.jsp" class="btn btn-light btn-sm">Back to Home</a>
                <a href="Controller?dispatchto=LoginView" class="btn btn-primary btn-sm">Try Again</a>
            </div>
        </div>
    </div>
</div>
