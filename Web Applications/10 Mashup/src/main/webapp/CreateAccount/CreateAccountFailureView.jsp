...
<html lang="en">
<head>
    <title>Sports Club Altenstadt - Create Account - Failure</title>
    <meta charset="utf-8">
...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div class="p-4 p-md-5 pt-5" id="content">
        <h2 class="mb-4">Create Account Message</h2>

        <div class="card text-white bg-danger">
            <div class="card-header">Failure</div>
            <div class="card-body">
                <h5 class="card-title">We are sorry!</h5>
                <p class="card-text">
                    We are sorry, but the user ID "${sessionScope.createAccount.userID}" is already taken.<br>
                    Please choose another user ID.
                </p>
            </div>
            <div class="card-footer bg-transparent border-danger">
                <a href="index.jsp" class="btn btn-light btn-sm">Back to Home</a>
                <a href="Controller?dispatchto=CreateAccountView" class="btn btn-primary btn-sm">Try Again</a>
            </div>
        </div>
    </div>
</div>
