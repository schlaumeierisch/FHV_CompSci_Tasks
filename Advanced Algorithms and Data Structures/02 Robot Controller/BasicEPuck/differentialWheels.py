...
class DifferentialWheels:
    ...
    def __init__(self, name):
        ...
        self._enabledProximitySensors = np.array([], dtype=int)
        self._lightSensorsEnabled = False
        self._numLightSensors = 0
        self._enabledLightSensors = np.array([], dtype=int)
        ...
        self._proximitySensorValues = np.array([], dtype=float)
        self._lightSensorValues = np.array([], dtype=float)
        self._groundSensorValues = np.array([], dtype=float)
        self._accelerometerValues = np.array([], dtype=float)
        self._wheelEncoderValues = np.array([], dtype=float)
